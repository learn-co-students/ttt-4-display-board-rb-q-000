...
describe "#display_board in 'lib/display_board.rb" do
  ...
  context 'various game situations' do
    ...
    it 'prints an entire board full of Xs' do
      ...
      # *** Edit the line below ***
      board = ["X", "X", "X", "X", "X", "X", "X", "X", "X"] # AYupdated
      ...
      # *** AY Edited the lines below ***
      # *** AY Uncommented the lines below ***
      expect(output).to include(" X | X | X ")
      expect(output).to include("-----------")
      expect(output).to include(" X | X | X ")
      expect(output).to include("-----------")
      ...
      # *** AY Commented the line below by adding a # at the line start ***
    ...
    it 'prints an entire board full of Os' do
      ...
      # example's situation.
      board = ["O", "O", "O", "O", "O", "O", "O", "O", "O"] # AYupdated
